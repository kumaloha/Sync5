...
> **状态(2026-09-08 晚):12 任务全部落 main,代码定稿 `ab1543e`(含 4b/8b/8c/8d+9b/8e 五次审查修补);全量单测 3648/0;adsprobe 0 违规;欠用户侧四件见 Task 11 Step 4 / TODO ⑦。**
...
- [ ] **Step 1: 先看 parity 现在是绿的(基线;4b 已让 fork 拷 ad_used)**
...
- **4b 审查修补后签名变了**:`Economy.ad_coins_allowed(run_used, shop_used, coins, slots)` 多了金币上限护栏(穷开心的 coin_cap 下 grant 一分不加就不许 offer);Task 7 的 `ad_offer_ok` 与 Task 9 的 bot 臂已按新签名改。
