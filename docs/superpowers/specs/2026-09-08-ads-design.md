...
> **状态:已实装(2026-09-08, 计划 12 任务 + 4b/8b/8c/8d+9b/8e 五次审查修补)**;`ad_coins_allowed` 比 §3.1 多了 `coins, slots` 两参(金币上限护栏)。
> ⚑ **2026-09-09 起 §1.3 / §2 的 ui 键 / §4.2–§4.4(denied 弹 offer · 常驻/行内 offer · 体力墙面板)被 [2026-09-09-sponsor-design.md](2026-09-09-sponsor-design.md) 取代**;§1.1–1.2 两个判断、上限、§3 core、§4.1 适配层、§5 Tape、§6 仪器、§8 SDK 继续有效。欠用户侧四件见 TODO 路线 ⑦。
