...
>
> **2026-08-09 重组完成:编号全部去掉,按主题命名(篇数以目录为准)。**
...
|---|---|---|
| ① | **README**(本篇) | 导览 |
| ② | [**jokers**](jokers.md) | 小丑牌 —— 16 条设计原则 · 钩子契约 · 校准史(主角已删) |
...
| ⑥ | [**ui_meta**](ui_meta.md) | UI 愿景(前瞻)+ 现行 UI 实现节(权威)。META 部分已随局外 build 删除(2026-08-24) |
...
| ⑪ | [**consumables**](consumables.md) | **消耗牌**(2026-08-30 开轴)—— 一次性 vs 持续的分界 · 全自动触发与待播队列 · 一次性卡的定价量纲 · 它顺带解决了「经济不稀缺」 |
| ⑫ | [**telemetry**](telemetry.md) | 打点 —— 21 类事件 · 口径铁律 |

**其余四篇(导览此前漏列, 09-06 补)**:[`blinds_review.md`](blinds_review.md)(脸的评审记录)· [`rebalance_draft.md`](rebalance_draft.md)(经济重标草稿)· [`taptap.md`](taptap.md)(上架调研, **结论已推翻**, 见文首横幅)· [`feedback_20260827.md`](feedback_20260827.md)(试玩反馈记录)。
