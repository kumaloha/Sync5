...
| ⑥ | [**ui_meta**](ui_meta.md) | UI 愿景(前瞻)+ 现行 UI 实现节(权威)+ META 三层生命周期总表;**资产循环已实施,规格在 meta.md** |
...
| [**meta**](meta.md) | **META 资产循环**(2026-08-19 设计稿)—— 「买了就想玩」入表判据 · 经济原则 · 赛季上架窗口 · IAP 两岔的后果 · **待拍岔路 5 条**。接管 ui_meta.md META 节的资产部分 |
