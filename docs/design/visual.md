...
mechanic rationale remains in `docs/design/`; implementation details remain in
`docs/design/tech.md`.
...
- `docs/design/ui_meta.md` — current screen hierarchy and layout history.
- `docs/design/jokers.md` — current Joker mechanics and balance rationale.
- `docs/design/blinds.md` — current Blind mechanics, proof lanes, and balance gates.
- `docs/design/tech.md` — runtime architecture and asset/rendering conventions.
