...
return {
	...
	["shop"] = {
		...
		["cons_disc"] = 132,
		["cons_col_w"] = 190,
		["_comment_cons_3"] = "三碟时(货架第三位是赞助碟, 2026-09-09)的列宽 —— 间距沿用 cons_gap, 起点由同一条居中公式算出 = 192(碟位 201/375/549, 画布 Main.dc.html)。⚠ 无广告时仍走 cons_col_w 的两碟版(碟位 268/482)——「离线 = 今天的商店, 一像素不差」是这次的红线。",
		["cons_col_w_3"] = 150,
		["cons_gap"] = 24,
		["cons_left"] = 190,
		["cons_right"] = 692,
